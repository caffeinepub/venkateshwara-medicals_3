  ...
  return (
    <div className="min-h-screen bg-background font-body">
      ...
      <main className="container mx-auto px-4 py-10">
        {/* Not authenticated — username/password login */}
        {!isAuthenticated && (
          <motion.div
            ...
            <div className="bg-card rounded-xl border border-border shadow-xs overflow-hidden">
              ...
              {isLoadingProducts ? (
                ...
                >
                  ...
                  <p className="font-ui font-medium mb-1">No products yet</p>
                  <p className="text-sm">
          ...
          <div className="space-y-4 py-2">
            <div>
              ...
              {formErrors.name && (
                <p
                  ...
                  data-ocid="admin.product.name.error"
                >
                  {formErrors.name}
                </p>
              )}
            ...
            <div>
              ...
              {formErrors.description && (
                <p
                  className="text-destructive text-xs mt-1 font-body"
                  data-ocid="admin.product.description.error"
                >
                  {formErrors.description}
                </p>
              )}
            ...
            <div>
              ...
              {formErrors.price && (
                <p
                  className="text-destructive text-xs mt-1 font-body"
                  data-ocid="admin.product.price.error"
                >
                  {formErrors.price}
                </p>
              )}
